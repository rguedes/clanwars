 ...
 *
 * @author akeinhell
 * @method static \Wot\Clan\Helpers\Dreamfactory playup()
 * @method static \Wot\Clan\Helpers\Dreamfactory users()
 */
class Dreamfactory
{
     ...
     */
    private static $URL = 'http://api.worldoftanks.%s/rest/%s/';
    ...
    /**
     * @var \Wot\Clan\Helpers\Api|null Экземпляр обьекта
     */
    ...
    private static function createUrl($name, $arguments = array())
    {
        try {
            ...
            $args = array('app_name' => self::$Appid);
    ...
    public static function __callStatic($name, $arguments)
    {
        switch (strtolower($name)) {
            ...
            case 'wow':
                ...
                break;
            default:
                self::setURL('http://api.worldoftanks.%s/rest/%s/');
